...
async function Regel2Test2() {
    ...
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func1R3T2()));
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func2R3T2()));
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func3.O3));
    console.log(await func4.O3);
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func5[5]));
    console.log(await func6[5]);
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func7[1]));
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func8[4].O2));
    console.log(await func9[4].O2);
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func10[1].O4[2]));
    console.log(await func11[1].O4[2]);
    console.log(await window.crypto.subtle.encrypt({ name: "AES-GCM", iv: window.crypto.getRandomValues(new Uint8Array(16)), }, AESKeyR3T2, await func12R3T2()));
}
