(function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
  ...
  document.addEventListener("DOMContentLoaded", function(event) {
   ...
   async function laden() {
    ...
    function Regel2(WebCryptoAPIScripts) {
      for (let i = 0; i < WebCryptoAPIScripts.regel2.length; i++) {
        ...
        if (encMode === "AES-CBC" || encMode === "AES-CTR" && WebCryptoAPIScripts.regel3.length != 0) {
          console.log("Regel 2")
        } 
        else {
      ...
      for (let i = 0; i < WebCryptoAPIScripts.regel2.length; i++) {
        ...
        let signTyp = walk.findNodeAround(WebCryptoAPIScripts.ast, WebCryptoAPIScripts.regel2[i],  "CallExpression").node.arguments[0].properties[0].value.value;
        if (signTyp === "RSASSA-PKCS1-v1_5" || signTyp === "RSA-PSS" || signTyp === "ECDSA" || signTyp === "HMAC") {
          console.log(WebCryptoAPIScripts.src)
          if (WebCryptoAPIScripts.regel1.length =! 0) {
            WebCryptoAPIScripts.regel1.forEach(element => {
              walk.findNodeAround(WebCryptoAPIScripts.ast, element,  "CallExpression").node.arguments[0].properties
            });
          }
          else {
  ...
  async function identifierValueCheck(node, WebCryptoAPIScripts) {
    ...
    if(SwitchOrIf.length > 0) {
      ...
      found.forEach(element => {if (element.keepMe === true) {
